# Step 1b Clayton-Weibull model pseudo-log-likelihood, with plugged-in estimated lambda, k and beta from step 1a
# p include copula parameter (eta)
# p2 include Weibull baseline parameters (lambda, k), regression parameter(s) (beta)
...
step1b <-function(p, p2, x1, x2,status1,status2, var_list)
{
